...
def get_params():
    params = {
        'weight': r'C:\python work\ultralytics-yolo11-main\runs\train\yolo11s-seg-private date\weights\best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'C:\python work\ultralytics-yolo11-main\private date\test\images\image5_jpg.rf.eeb488f654d9acb08aaf2cb4799e79ab.jpg', 'result')